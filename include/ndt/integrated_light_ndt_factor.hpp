...
class IntegratedLightNDTFactor_ : public gtsam_points::IntegratedMatchingCostFactor {
public:
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW
  using shared_ptr = gtsam_points::shared_ptr<IntegratedLightNDTFactor_>;

  IntegratedLightNDTFactor_(
  ...
  virtual ~IntegratedLightNDTFactor_() override;
  ...
  gtsam::NonlinearFactor::shared_ptr clone() const override {
    return gtsam::NonlinearFactor::shared_ptr(new IntegratedLightNDTFactor_(*this));
  }
...
using IntegratedLightNDTFactor = IntegratedLightNDTFactor_<>;
