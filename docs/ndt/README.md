...
| 문서 | 설명 |
|------|------|
| [usage_guide.md](./usage_guide.md) | NDT 사용 가이드 |
| [uml.md](./uml.md) | UML 클래스/시퀀스 다이어그램 |
| [scoreless_weight_only_method_ko.md](./scoreless_weight_only_method_ko.md) | score 없이 `J^TΣ^-1J` 중심으로 푸는 방식 설명 |
| [comparison/ndt_lightndt_gicp_수학_컨셉_비교.md](./comparison/ndt_lightndt_gicp_수학_컨셉_비교.md) | NDT/LightNDT/GICP 수학·컨셉 비교 |
| [analysis/why_ndt_is_slow_in_gtsam_lm_h1only_상세분석_ko.md](./analysis/why_ndt_is_slow_in_gtsam_lm_h1only_상세분석_ko.md) | NDT 저속 원인 상세 분석 |
| [experiments/full_project_factor_실험_수학코드_종합보고서_2026-03-06.md](./experiments/full_project_factor_실험_수학코드_종합보고서_2026-03-06.md) | 전체 factor 실험/코드 종합 보고 |
| [checklists/factor_개선_실행체크리스트_2026-03-06.md](./checklists/factor_개선_실행체크리스트_2026-03-06.md) | 실행 체크리스트 |
| [../archive/2026-02/ndt_implementation_ko.md](../archive/2026-02/ndt_implementation_ko.md) | 초기 구현 문서 (아카이브) |
| [analysis/NDT_수학_코드_7문항_상세분석_2026-03-09.md](./analysis/NDT_수학_코드_7문항_상세분석_2026-03-09.md) | d1/d2/d3, Jacobian 4×6, J_target/source, cost -d1, weight, LM 불일치 7문항 |
| [analysis/NDT_Hessian_H1_H2_H3_수학_분석_2026-03-09.md](./analysis/NDT_Hessian_H1_H2_H3_수학_분석_2026-03-09.md) | **H1/H2/H3 Hessian 수학적 분해** — PSD 조건, 수렴 효과, GTSAM 호환성, 달팽이 수렴 원인 |
| [analysis/NDT_가평균_가분산_계산방식_상세분석.md](./analysis/NDT_가평균_가분산_계산방식_상세분석.md) | **가평균/가분산 계산 방식 상세 분석** — GaussianVoxel의 mean/cov 파이프라인 (KNN→복셀 집계→역공분산), CPU/GPU 수식, VGICP-style vs 전통 NDT 비교 |
