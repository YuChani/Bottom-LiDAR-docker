...
| `docs/gmm/gmm-voxel-structure-study.md` | **GMM/gtsam_points 복셀 생성 구조 학습 가이드** (IncrementalVoxelMap 해싱, GaussianVoxel vs GMMVoxel, Reservoir→EM, Factor 비교, Armadillo 의존성) |
